...
public class Professional_qualification {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("#EmailAddress")).sendKeys("pslp1@gmail.com");
...
//		driver.findElement(By.id("PostBackModel_ParentOrCarerFirstName")).sendKeys("hdcosdlki");
//		driver.findElement(By.id("PostBackModel_ParentOrCarerLastName")).sendKeys("ldkkoklio");
//		driver.findElement(By.id("PostBackModel_ParentOrCarerRelationshipToStudent")).sendKeys("dkoupfdc");
...
//		driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div/div/div[2]/form/div[6]/div[1]/label")).click();
		...
		// driver.findElement(By.id("single-select")).sendKeys("Law");//professional
		driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div/div/div[2]/form/input[2]")).click();
		...
		// step 9
//		driver.findElement(By.id("PostBackModel_LastCollegeOrSchool")).sendKeys("sdadaddc");
//		driver.findElement(By.id("PostBackModel_Qualifications_0__Subject")).sendKeys("sscince");
//		driver.findElement(By.id("PostBackModel_Qualifications_0__Type")).sendKeys("senglish");
...
//		driver.findElement(By.id("PostBackModel_Religion")).sendKeys("Zdhjd");
//		driver.findElement(By.id("PostBackModel_FirstLanguage")).sendKeys("Zsdsjsc");
//		Thread.sleep(3000);
//
...
//		driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div/div/div[2]/form/div[34]/label")).click();// no
		...
		// step 12
//		driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div/div/div[2]/form/div[1]/label")).click();
//		driver.findElement(By.id("single-select")).sendKeys("TV");
